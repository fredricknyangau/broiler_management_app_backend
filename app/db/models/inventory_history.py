...
class InventoryHistory(Base, UUIDMixin, TimestampMixin):
    ...
    )  # Enum: purchase, consumption, adjustment, etc.
    quantity_change = Column(
        DECIMAL(10, 2), nullable=False, doc="Positive or negative change"
    )
    ...
    inventory_item = relationship(
        "InventoryItem",
        backref=backref("history_logs", cascade="all, delete-orphan"),
