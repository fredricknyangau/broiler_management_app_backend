...
class DailyCheck(Base, UUIDMixin, TimestampMixin):
    ...
    chick_behavior = Column(
        String(50), doc="Qualitative assessment: normal, huddling, panting..."
    )
    litter_condition = Column(
        String(50), doc="Condition of bedding: dry, wet, caked..."
    )
