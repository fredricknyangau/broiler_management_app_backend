...
class VaccinationEventCreate(BaseModel):
    ...
    vaccine_name: str
    disease_target: str
    administration_method: str = Field(
        ..., pattern="^(drinking_water|eye_drop|injection|spray)$"
    )
...
class VaccinationEventUpdate(BaseModel):
    ...
    administration_method: Optional[str] = Field(
        None, pattern="^(drinking_water|eye_drop|injection|spray)$"
    )
    dosage: Optional[str] = None
    administered_by: Optional[str] = None
    batch_number: Optional[str] = None
