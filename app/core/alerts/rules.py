...
from app.core.alerts.base import AlertResult, AlertRule, AlertSeverity
    ...
    def evaluate(self, context: Dict[str, Any]) -> Optional[AlertResult]:
        ...
        if days_until == 0:
            return AlertResult(
                ...
                metadata={"vaccine_name": vaccine_name, "due_date": str(next_due_date)},
            )
